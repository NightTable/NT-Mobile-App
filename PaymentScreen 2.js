    ...
    const handleConfirmCard = async () => {
        try {
            ...
            */
            ...
            const responseStripeCustomer = await axios.get(`${API_URL}/get-stripe-customer/${responseInternalCustomer.data.stripeCustomerId}`);
            ...
            */
            ...
            const updatedCustomerPaymentIntent = await axios.patch(`${API_URL}/update-internalCustomer/${responseInternalCustomer.data._id}`, {
            ...
            */
            ...
            const updatedCustomerSecondPaymentIntent = await axios.patch(`${API_URL}/update-internalCustomer/${responseInternalCustomer.data._id}`, {
                paymentIntentIds: [...paymentIntentIds, responsePaymentIntentSNPL.data.paymentIntent.id]
            });
