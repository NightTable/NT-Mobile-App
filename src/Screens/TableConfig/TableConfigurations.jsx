    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          may request for a low fee or no-fee to join a table.
        </Text>
      </Box>
      <Box style={{ flex: 1, /*borderWidth: 2, borderColor: 'green'*/}}>
        {/* This Box contains your headers "Table Map ID", "Table Type", "Table Minimum" */}
        <Box style={{ flex: 1, /*borderWidth: 2, borderColor: 'green'*/ }}>
          <Box style={{ flexDirection: "row", justifyContent: "space-evenly", /*borderWidth: 2, borderColor: 'blue', marginBottom: 50*/ }}>
            <Box style={styles.splitBox}><Text style={[typography.bold.bold16, { color: colors.gold.gold200 }]}>Table Map ID</Text></Box>
            <Box style={styles.splitBox}><Text style={[typography.bold.bold16, { color: colors.gold.gold200 }]}>Table Type</Text></Box>
            <Box style={styles.splitBox}><Text style={[typography.bold.bold16, { color: colors.gold.gold200 }]}>Table Minimum</Text></Box>
          </Box>
          <ScrollView style={{ borderWidth: 2, borderColor: colors.gold.gold200, borderRadius: 15, flex: 1, /*marginTop: -10*/ }} showsVerticalScrollIndicator={true}>
            {renderTableConfigs()}
          </ScrollView>
        </Box>
      ...
      <Box style={{ height: "20%", flex: 1, padding: 20, /*borderWidth: 2, borderColor: 'red'*/}}>
        <TouchableOpacity
          ...
          style={{ marginTop: '30%', backgroundColor: colors.gold.gold200, alignItems: 'center', justifyContent: 'center', padding: 10, borderRadius: 5, borderWidth: 2, borderColor: colors.gold.gold100 }}
        >
