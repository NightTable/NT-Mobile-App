    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={[styles.mainBox]}>
          <Text style={[styles.heading]}>
            Want to become a club promoter ? Please fill out this form and your Application will be sent to the club for
            review
          </Text>
